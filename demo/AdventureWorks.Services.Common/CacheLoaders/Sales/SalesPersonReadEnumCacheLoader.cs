...
{
    public partial class SalesPersonReadEnumCacheLoader : LookupCacheLoader 
    {
        public SalesPersonReadEnumCacheLoader(IServiceProvider serviceProvider)
            : base(serviceProvider, LookupCache.Global, true, "sales person")
        {
        }

        protected virtual async Task<Output<ICollection<SalesPerson_ReadEnumOutput>>> ReadEnumAsync(CancellationToken token = default)
        {
