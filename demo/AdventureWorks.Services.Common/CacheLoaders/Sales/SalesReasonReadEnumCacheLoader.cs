...
{
    public partial class SalesReasonReadEnumCacheLoader : LookupCacheLoader 
    {
        public SalesReasonReadEnumCacheLoader(IServiceProvider serviceProvider)
            : base(serviceProvider, LookupCache.Global, true, "sales reason")
        {
        }

        protected virtual async Task<Output<ICollection<SalesReason_ReadEnumOutput>>> ReadEnumAsync(CancellationToken token = default)
        {
