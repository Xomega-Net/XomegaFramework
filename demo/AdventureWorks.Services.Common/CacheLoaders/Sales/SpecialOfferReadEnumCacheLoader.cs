...
{
    public partial class SpecialOfferReadEnumCacheLoader : LookupCacheLoader 
    {
        public SpecialOfferReadEnumCacheLoader(IServiceProvider serviceProvider)
            : base(serviceProvider, LookupCache.Global, true, "special offer")
        {
        }

        protected virtual async Task<Output<ICollection<SpecialOffer_ReadEnumOutput>>> ReadEnumAsync(CancellationToken token = default)
        {
