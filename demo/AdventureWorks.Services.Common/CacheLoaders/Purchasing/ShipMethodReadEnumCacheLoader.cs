...
{
    public partial class ShipMethodReadEnumCacheLoader : LookupCacheLoader 
    {
        public ShipMethodReadEnumCacheLoader(IServiceProvider serviceProvider)
            : base(serviceProvider, LookupCache.Global, true, "ship method")
        {
        }

        protected virtual async Task<Output<ICollection<ShipMethod_ReadEnumOutput>>> ReadEnumAsync(CancellationToken token = default)
        {
