...
namespace AdventureWorks.Services
{
    ...
    {
        public ProductReadListCacheLoader()
            : base(LookupCache.Global, false, "product")
        {
        }

        protected virtual IEnumerable<Product_ReadListOutput> ReadList()
        {
            IProductService svcProduct = DI.Resolve<IProductService>();
            IEnumerable<Product_ReadListOutput> outReadList = svcProduct.ReadList();
            if (svcProduct is IDisposable) ((IDisposable)svcProduct).Dispose();
            return outReadList;
        }
